...
task :refresh_sitemaps => :environment do
  if Rails.env.production?
    ...
    Kernel.system "ln -nfs #{deploy_to}/shared/sitemaps/sitemap.xml.gz #{deploy_to}/current/public/sitemap.xml.gz"
    Kernel.system "ln -nfs #{deploy_to}/shared/sitemaps/sitemap.xml #{deploy_to}/current/public/sitemap.xml"
  else
